...
const ProjectCarousel = () => (
  <>
    <div className="product__highlights">
      ...
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. In quo hic
        voluptatum accusamus, architecto quae exercitationem suscipit officia
        consequatur tenetur provident eligendi distinctio. Amet impedit quisquam
        officiis similique cupiditate illum totam, recusandae odit placeat
        nostrum ex inventore odio quam fugiat tempora porro magni veritatis
        mollitia voluptatum.
      </p>
    </div>
    <Carousel autoPlay>
